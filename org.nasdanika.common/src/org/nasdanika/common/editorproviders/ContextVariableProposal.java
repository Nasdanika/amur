...
final class ContextVariableProposal implements ICompletionProposal {
	 ...
	 */
	public ContextVariableProposal(TemplateVariableResolver variable, int offset, int length, ITextViewer viewer) {
		fVariable= variable;
		fOffset= offset;
		fLength= length;
		fViewer= viewer;
	...
	public void apply(IDocument document) {
		...
		try {
			...
			MessageDialog.openError(shell, "Error applying context variable proposal", e.getMessage());
		}
	}
