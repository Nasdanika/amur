...
final class ContextVariableProcessor implements IContentAssistProcessor {

	private static Comparator fgTemplateVariableProposalComparator= new Comparator() {
		public int compare(Object arg0, Object arg1) {
			ContextVariableProposal proposal0= (ContextVariableProposal) arg0;
			ContextVariableProposal proposal1= (ContextVariableProposal) arg1;
	...
	public ICompletionProposal[] computeCompletionProposals(ITextViewer viewer,	int documentOffset) {
		...
		for (Iterator iterator= fContextType.resolvers(); iterator.hasNext(); ) {
			...
			if (prefix == null || variable.getType().startsWith(prefix))
				proposals.add(new ContextVariableProposal(variable, offset, length, viewer));
		}
