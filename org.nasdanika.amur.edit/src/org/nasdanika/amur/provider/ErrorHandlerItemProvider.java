...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.ErrorHandler} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
...
//			addErrorTypePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorHandler_errorType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorHandler_errorType_feature", "_UI_ErrorHandler_type"),
				 AmurPackage.Literals.ERROR_HANDLER__ERROR_TYPE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return AmurEditPlugin.INSTANCE.adjustImage(object, getAdapterFactory(), overlayImage(object, org.nasdanika.common.Activator.getImageDescriptor("icons/led/cancel.png")));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			typeName(object, "_UI_ErrorHandler_type") :
			typeName(object, "_UI_ErrorHandler_type") + " " + label;
	}
