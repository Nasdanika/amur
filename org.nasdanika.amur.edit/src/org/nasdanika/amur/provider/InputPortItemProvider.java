...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.InputPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputPortItemProvider
	...
	public Object getImage(Object object) {
		return AmurEditPlugin.INSTANCE.adjustImage(object, getAdapterFactory(), overlayImage(object, getResourceLocator().getImage("full/obj16/InputPort")));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			typeName(object, "_UI_InputPort_type") :
			typeName(object, "_UI_InputPort_type") + " " + label;
	}
