 ...
 * @generated
 */
public class AmurModelingAssistantProviderOfConnectionTarget2EditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((ConnectionTarget2EditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ConnectionTarget2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ConnectionTarget2EditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			ConnectionTarget2EditPart target, IElementType relationshipType) {
