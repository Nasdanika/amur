 ...
 * @generated
 */
public class AmurModelingAssistantProviderOfConnectionSource2EditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ConnectionSource2EditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			ConnectionSource2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(ConnectionSource2EditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			ConnectionSource2EditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ConnectionSource2EditPart) sourceEditPart,
				relationshipType);
	}

	/**
	 * @generated - Gateway commented out.
	 */
	public List<IElementType> doGetTypesForTarget(
			ConnectionSource2EditPart source, IElementType relationshipType) {
...
//			//types.add(AmurElementTypes.Gateway_3005);
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ConnectionSource2EditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ConnectionSource2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ConnectionSource2EditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			ConnectionSource2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
