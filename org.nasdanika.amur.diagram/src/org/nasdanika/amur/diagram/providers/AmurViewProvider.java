 ...
 * @generated
 */
public class AmurViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = AmurVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = AmurVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!AmurElementTypes.isKnownElementType(elementType)
		...
		return GatewayEditPart.VISUAL_ID == visualID
				...
				|| ConnectionSourceEditPart.VISUAL_ID == visualID
				|| ConnectionTargetEditPart.VISUAL_ID == visualID
				|| ErrorHandlerEditPart.VISUAL_ID == visualID
				|| OutputPortEditPart.VISUAL_ID == visualID
				|| InputPortEditPart.VISUAL_ID == visualID
				|| Node2EditPart.VISUAL_ID == visualID
				|| ConnectionSource2EditPart.VISUAL_ID == visualID
				|| ConnectionTarget2EditPart.VISUAL_ID == visualID
				|| Container2EditPart.VISUAL_ID == visualID
				|| ErrorHandler2EditPart.VISUAL_ID == visualID
				|| Gateway2EditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = AmurVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != AmurVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = AmurVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = AmurVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case GatewayEditPart.VISUAL_ID:
		...
		case ContainerEditPart.VISUAL_ID:
			return createContainer_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConnectionSourceEditPart.VISUAL_ID:
			return createConnectionSource_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case ConnectionTargetEditPart.VISUAL_ID:
			return createConnectionTarget_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		case ErrorHandlerEditPart.VISUAL_ID:
			return createErrorHandler_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case OutputPortEditPart.VISUAL_ID:
			return createOutputPort_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case InputPortEditPart.VISUAL_ID:
			return createInputPort_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node2EditPart.VISUAL_ID:
			return createNode_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConnectionSource2EditPart.VISUAL_ID:
			return createConnectionSource_3001(domainElement, containerView,
					index, persisted, preferencesHint);
		case ConnectionTarget2EditPart.VISUAL_ID:
			return createConnectionTarget_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case Container2EditPart.VISUAL_ID:
			return createContainer_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ErrorHandler2EditPart.VISUAL_ID:
			return createErrorHandler_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case Gateway2EditPart.VISUAL_ID:
			return createGateway_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node3EditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (AmurVisualIDRegistry.getVisualID(elementTypeHint)) {
		case TransitionEditPart.VISUAL_ID:
			return createTransition_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case CallEditPart.VISUAL_ID:
			return createCall_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ErrorTransitionEditPart.VISUAL_ID:
			return createErrorTransition_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ReferenceEditPart.VISUAL_ID:
			return createReference_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case GatewayMergeSourceEditPart.VISUAL_ID:
			return createGatewayMergeSource_4005(containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createGateway_2001(EObject domainElement, View containerView,
		...
		node.setType(AmurVisualIDRegistry.getType(GatewayEditPart.VISUAL_ID));
	...
	public Node createContainer_2002(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(ContainerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createConnectionSource_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createConnectionTarget_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createErrorHandler_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createOutputPort_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(OutputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createInputPort_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(InputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2008(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(Node2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createConnectionSource_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createConnectionTarget_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createContainer_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(Container2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createErrorHandler_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createGateway_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(Gateway2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Node createNode_3006(EObject domainElement, View containerView,
		...
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AmurVisualIDRegistry.getType(Node3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(AmurVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createCall_4002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(AmurVisualIDRegistry.getType(CallEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createErrorTransition_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(AmurVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createReference_4004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(AmurVisualIDRegistry.getType(ReferenceEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createGatewayMergeSource_4005(View containerView, int index,
