...
import org.nasdanika.amur.diagram.part.AmurDiagramEditor;
 ...
 * @generated
 */
public class AmurValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = AmurDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof AmurDiagramEditor) {
			...
			for (int i = 0; i < markers.length; i++) {
				...
				String attribute = marker
						.getAttribute(
								...
								""); //$NON-NLS-1$
				EObject vObj = view.eResource().getEObject(attribute);
				EObject vElement = vObj instanceof View ? ((View) vObj).getElement() : null;
//				if (vElement instanceof Node && element instanceof Node) {
//					System.out.println("--- "+((Node) vElement).getId()+" "+((Node) vElement).getName());
//					System.out.println(((Component) element).getId()+" "+((Component) element).getName());
//				}
				if (vElement == element) {
