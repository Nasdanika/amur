...
import org.nasdanika.amur.diagram.part.AmurDiagramEditorUtil;
...
public class OpenDiagramEditPolicy extends OpenEditPolicy {
	...
	/**
	 * @generated NOT - opening sub-diagram if composite.
	 */
	protected Command getOpenCommand(Request request) {
		EditPart targetEditPart = getTargetEditPart(request);
		if (targetEditPart instanceof Node2EditPart || targetEditPart instanceof Node3EditPart) {
			Node se = (Node) ((Node2EditPart) targetEditPart).resolveSemanticElement();
			if (se.getImplementationType()==null || !se.getImplementationType().isComposite()) {
				return null;
			}
		}
