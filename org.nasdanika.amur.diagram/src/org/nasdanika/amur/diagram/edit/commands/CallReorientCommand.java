...
public class CallReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Call) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return AmurBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistCall_4002(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return AmurBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistCall_4002(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Call getLink() {
		return (Call) getElementToEdit();
	}
