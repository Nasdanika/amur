 ...
 * @generated
 */
public class InputPortNameEditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.InputPortNameEditPart.VISUAL_ID));
		}
		return parser;
	}
