...
import org.nasdanika.amur.diagram.edit.policies.AmurTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConnectionTargetNameEditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConnectionTargetNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new AmurTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AmurParserProvider
					.getParser(
							AmurElementTypes.ConnectionTarget_2004,
							getParserElement(),
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.ConnectionTargetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					AmurEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
