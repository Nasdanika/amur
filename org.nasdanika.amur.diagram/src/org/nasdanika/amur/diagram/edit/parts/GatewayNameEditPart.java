 ...
 * @generated
 */
public class GatewayNameEditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.GatewayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
