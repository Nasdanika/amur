 ...
 * @generated
 */
public class GatewayName2EditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GatewayName2EditPart(View view) {
		super(view);
	}
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.GatewayName2EditPart.VISUAL_ID));
		}
		return parser;
	}
