 ...
 * @generated
 */
public class ContainerName2EditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.ContainerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
