 ...
 * @generated
 */
public class ContainerNameEditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.ContainerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
