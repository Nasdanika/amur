...
import org.nasdanika.amur.diagram.edit.policies.ErrorHandler2ItemSemanticEditPolicy;
import org.nasdanika.amur.diagram.part.AmurVisualIDRegistry;

/**
 * @generated
 */
public class ErrorHandler2EditPart extends AmurShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ErrorHandler2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ErrorHandler2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ErrorHandlerName2EditPart) {
			((ErrorHandlerName2EditPart) childEditPart)
