...
import org.nasdanika.amur.diagram.edit.policies.CallItemSemanticEditPolicy;

/**
 * @generated
 */
public class CallEditPart extends AmurConnectionNodeEditPart implements
		ITreeBranchEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallNameEditPart) {
			((CallNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureCallNameFigure());
			return true;
		}
		return false;
	}
