 ...
 * @generated
 */
public class OutputPortNameEditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.OutputPortNameEditPart.VISUAL_ID));
		}
		return parser;
	}
