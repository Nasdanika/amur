 ...
 * @generated
 */
public class ErrorHandlerName2EditPart extends AmurCompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ErrorHandlerName2EditPart(View view) {
		super(view);
	}
			...
			parser = AmurParserProvider
					.getParser(
							...
							AmurVisualIDRegistry
									.getType(org.nasdanika.amur.diagram.edit.parts.ErrorHandlerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
