 ...
 * @generated
 */
public class TransitionNameEditPart extends AmurLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AmurVisualIDRegistry
						.getType(org.nasdanika.amur.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
