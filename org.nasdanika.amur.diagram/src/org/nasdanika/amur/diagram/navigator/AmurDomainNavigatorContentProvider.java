 ...
 * @generated
 */
public class AmurDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AmurDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof AmurDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((AmurDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new AmurDomainNavigatorItem((EObject) objects[i],
