...
import org.nasdanika.amur.diagram.providers.AmurMarkerNavigationProvider;
import org.nasdanika.amur.diagram.providers.AmurValidationDecoratorProvider;
import org.nasdanika.amur.diagram.providers.AmurValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (AmurDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		AmurValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		AmurValidationDecoratorProvider.refreshDecorators(view);
	}
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		AmurDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new AmurDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = AmurDiagramEditorUtil.findView(diagramEditPart,
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		AmurMarkerNavigationProvider.addMarker(target, elementId, location,
