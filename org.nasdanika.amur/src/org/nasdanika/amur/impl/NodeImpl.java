...
public class NodeImpl extends CompositeImpl implements Node {
	...
	public EList<Connection> getOutboundConnections() {
		return (EList<Connection>)eDynamicGet(AmurPackage.NODE__OUTBOUND_CONNECTIONS, AmurPackage.Literals.ABSTRACT_CONNECTION_SOURCE__OUTBOUND_CONNECTIONS, true, true);
	}
	...
	public EList<Connection> getInboundConnections() {
		return (EList<Connection>)eDynamicGet(AmurPackage.NODE__INBOUND_CONNECTIONS, AmurPackage.Literals.ABSTRACT_CONNECTION_TARGET__INBOUND_CONNECTIONS, true, true);
	}
