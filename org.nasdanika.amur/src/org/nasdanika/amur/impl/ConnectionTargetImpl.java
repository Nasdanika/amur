...
public class ConnectionTargetImpl extends ComponentImpl implements ConnectionTarget {
	...
	public EList<Connection> getInboundConnections() {
		return (EList<Connection>)eDynamicGet(AmurPackage.CONNECTION_TARGET__INBOUND_CONNECTIONS, AmurPackage.Literals.ABSTRACT_CONNECTION_TARGET__INBOUND_CONNECTIONS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AmurPackage.CONNECTION_TARGET__INBOUND_CONNECTIONS:
