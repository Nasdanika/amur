 ...
 * <ul>
 *   <li>{@link org.nasdanika.amur.impl.InputPortImpl#getOutboundConnections <em>Outbound Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InputPortImpl extends ComponentImpl implements InputPort {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return AmurPackage.Literals.INPUT_PORT;
	}
	...
	public EList<Connection> getOutboundConnections() {
		return (EList<Connection>)eDynamicGet(AmurPackage.INPUT_PORT__OUTBOUND_CONNECTIONS, AmurPackage.Literals.ABSTRACT_CONNECTION_SOURCE__OUTBOUND_CONNECTIONS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AmurPackage.INPUT_PORT__OUTBOUND_CONNECTIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractConnectionSource.class) {
			switch (derivedFeatureID) {
				case AmurPackage.INPUT_PORT__OUTBOUND_CONNECTIONS: return AmurPackage.ABSTRACT_CONNECTION_SOURCE__OUTBOUND_CONNECTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractConnectionSource.class) {
			switch (baseFeatureID) {
				case AmurPackage.ABSTRACT_CONNECTION_SOURCE__OUTBOUND_CONNECTIONS: return AmurPackage.INPUT_PORT__OUTBOUND_CONNECTIONS;
				default: return -1;
			}
		}
